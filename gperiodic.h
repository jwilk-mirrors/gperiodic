...
#define COPYRIGHT "Copyright (C) 1999-2002 Kyle R. Burton, 2003-2007 Jonas Frantz, 2014-2015 Alexey Loginov"
...
#define AUTHORS {"Kyle R. Burton", "Jonas Frantz", "Alexey Loginov", "Piotr Najman", "Arno W. Peters", "Georges Khaznadar", "Felix Natter", "Michael Shigorin", "Costantino Ceoldo", "Arkadiusz Lipiec", "Sebastien Bacher", "Daniel Leidert", "Theppitak Karoonboonyanan", "Zach Ploskey", "Jon Abbott", "Andrew Dalke", "Frederic Gobry", NULL}
